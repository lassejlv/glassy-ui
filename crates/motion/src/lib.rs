...
//!
//! Copied from [`loora-rs` `crates/ui/src/motion`](https://github.com/lassejlv/loora/tree/loora-rs/crates/ui/src/motion)
//! and extracted as a standalone crate.
